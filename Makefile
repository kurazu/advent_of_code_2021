...
day_22_task_1_larger_sample:
	poetry run python -m advent.day_22.task_1 data/day_22/larger_sample.txt
...
day_22_task_2_larger_sample:
	poetry run python -m advent.day_22.task_2 data/day_22/larger_sample.txt
